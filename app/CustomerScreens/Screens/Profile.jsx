        ...
        {["MyOrders", "MyAddresses"].map((route, index) => (
          ...
          >
            ...
            >
              <Ionicons
                name={
                  route === "MyOrders" ? "receipt-outline" : "location-outline"
                }
                size={24}
                color="#F8931F"
              />
...
const styles = StyleSheet.create({
  ...
  profilebackdrop: {
    ...
    width: 800,
    position: "absolute",
    top: Platform.OS === "android" ? 200 : 250, // Adjusted for Android
    left: -200,
    right: 0,
    bottom: 0,
    backgroundColor: "white",
    ...
    borderTopLeftRadius: "48%",
    borderTopRightRadius: "48%",
    zIndex: -1, // Ensure backdrop stays behind content
  },

  infoContainer: {
    marginTop: Platform.OS === "android" ? 40 : 80, // Reduced top margin for Android
    width: "100%",
    padding: 20,
    backgroundColor: "white",
    borderRadius: 15,
    marginBottom: 20, // Reduced bottom margin
    zIndex: 1, // Ensure content stays above backdrop
    ...Platform.select({
      ios: {
        shadowColor: "#000",
        shadowOffset: { width: 0, height: 2 },
  ...
  menuButton: {
    ...
    zIndex: 2, // Ensure buttons stay above backdrop
    ...Platform.select({
      ios: {
        shadowColor: "#000",
        shadowOffset: { width: 0, height: 2 },
  ...
  logoutContainer: {
    ...
    marginBottom: Platform.OS === "android" ? 30 : 20, // Added margin bottom
  },
});
