...
//     try {
//       const response = await axios.post('http://192.168.0.105:3500/auth/Register', data, {
//         headers: {
...
//           const otpResponse = await axios.post('http://192.168.0.105:3500/auth/generate-otp', {
...
//     console.log(otp);
//     try {
//       const response = await axios.post('http://192.168.0.105:3500/auth/verify-otp', {
//         phoneNumber: mobileNumber, // Using the full number including +91
//         otp: otp.join('')
//       });
//       if (response.status === 200) {
